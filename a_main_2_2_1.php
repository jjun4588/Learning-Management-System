...
<br>
			...
			$check1 = "UPDATE user_state SET state='복학 등록 완료' where id=$id";
			$check2 = "UPDATE user_state SET ustate='복학' where id=$id";
			...
			echo("<h3>복학</h3><br>");
			echo ("<form action='a_index_2_2.html' method='post'><table>
				<tr>
