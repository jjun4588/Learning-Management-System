...
<br><br>
  <div id = "thing1" align="center">
	<a href="s_index_3_1.html"><input type="submit" value="졸업조건조회" style="font-size:20px"></a>
	<a href="s_index_3_2.html"><input type="submit" value="조기졸업요건조회" style="font-size:20px"></a>
          <div class="cd1" >
            <div class="cd2">
<br>
                  <p><span style="background: linear-gradient(to right, #ffa7a3, #5673bd); padding: 0.43em 1em; font-size: 19px; border-radius: 3px; color: #ffffff;"> 졸업 </span></p><br>
                <p><span style="border-bottom: 12px solid #dcf1fb; padding: 0 0 0 0.2em;">메뉴를 선택하세요.</span></p>
<br>
              </div>
            </div>
          </div>
